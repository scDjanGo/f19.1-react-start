...
export default function ReactSneakersFavorites() {
  return (
    <div className="min-h-[50dvh] flex flex-col items-center justify-center">
      <p className="text-[70px]">😔</p>
      <div className="flex items-center flex-col gap-2.75 max-w-72.5 py-10">
        <p className="text-center text-[29px] font-semibold text-[#000000]">
          У вас нет заказов
        </p>
        <p className="text-center text-[16px] font-normal">Вы ничего не добавляли в закладки</p>
      </div>
